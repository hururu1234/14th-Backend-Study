...
public class TodoServiceTest {
    ...
    void setUp() {
        ...
        todo1Id = todoService.save(new TodoRequestDto("Test Todo 1", "Description 1")).id();
        todo2Id = todoService.save(new TodoRequestDto("Test Todo 2", "Description 2")).id();
    }
    ...
    void testFindById() {
        ...
        assertThat(todo.title()).isEqualTo("Test Todo 1");
    }
    ...
    void testUpdateTodo() {
        ...
        TodoResponseDto todo = todoService.findById(todo1Id);
        assertThat(todo.title()).isEqualTo("Updated Todo");
        assertThat(todo.description()).isEqualTo("Updated Description");
